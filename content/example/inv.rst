...
The true model (left) and recovered model (right) at iteration 4 are shown below. A cutoff of 0.0225 S/m has been used for both models. We should note some things about the inversion:
